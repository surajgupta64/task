    ...
    <>
      ...
      <div className="page_reducer_1">
        ...
        <div className="dbox-10">
          <div>
          <div className="text-center" style={{ fontSize: "23px" }}>View Exercises</div>
          <div className="d-flex mt-5 justify-content-between">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="#" onClick={() => setAction1("Select Category")}>Selrct Category</a>
                  <a class="dropdown-item" href="#" onClick={() => setAction1("cardio")}>cardio</a>
                  <a class="dropdown-item" href="#" onClick={() => setAction1("other")}>other</a>
                </div>
              </div>
