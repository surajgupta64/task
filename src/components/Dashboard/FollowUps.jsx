    ...
    <>
      ...
      <div className="page_reducer_1">
        <div className="dbox-10">
          ...
          <div className="d-flex align-items-center justify-content-center mt-3" style={{ gap: "30px" }}>
            ...
            <div className="btn-group">
              ...
              <div className="dropdown-menu">
                <a className="dropdown-item" href="#" onClick={() => setAction("All Staff")}>All Staff</a>
                <a className="dropdown-item" href="#" onClick={() => setAction("Riya")}>Riya</a>
              </div>
            </div>
            <div className="btn-group">
              <button type="button" className="btn btn-own dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div className="dropdown-menu">
                <a className="dropdown-item" href="#" onClick={() => setCall("All Calls")}>All Calls</a>
                <a className="dropdown-item" href="#" onClick={() => setCall("Missed Calls")}>Missed Calls</a>
              </div>
            </div>
            <div>
          ...
          <div className="text-center mb-2 mt-3" style={{ fontSize: "23px" }}>ENQUIRY CALLS</div>
