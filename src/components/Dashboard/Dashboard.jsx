        ...
        <>
            ...
            <div className="page_reducer_1">
                ...
                <div className="dsum-2">
                            ...
                            <div className="dbox-summary">
                                ...
                                {Dtask.map(data =>
                                    <div className={data.css}>
                                        <div className="row">
                                            <div className="col-lg-10"><div className={data.font}>{data.title}</div></div>
                                            <div className="col-lg-2"><div className={data.color}><b>{data.value}</b></div></div>
                                        </div>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <table className="table_client" border="1" cellSpacing="0" width="100%">
                                <tr className="text-center">
                                    <th colspan="3">Client Queries</th>
                                </tr>
                                <tr className="tr-client text-center">
                                    <td className="td-1">
                                        RAISED<br /><div className="blue">0</div>
                                    </td>
                                    <td className="td-2">
                                        CLOSED<br /><div className="green">0</div>
                                    </td>
                                    <td className="td-3">
                                        OPEN<br /><div className="red">0</div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div className="col-lg-4">
                            <table className="table_client" border="1" cellSpacing="0" width="100%">
                                ...
                                <tr className="tr-client text-center">
                                    <td className="td-1">
                                        BOOKED SEAT<br /><div className="blue">0</div>
                                    </td>
                                    <td className="td-2">
                                        RESERVED SEAT<br /><div className="green">0</div>
                                    </td>
                                    <td className="td-3">
                                        CANCEL SEAT<br /><div className="red">0</div>
                                    </td>
                                </tr>
                            </table>
                        </div>
